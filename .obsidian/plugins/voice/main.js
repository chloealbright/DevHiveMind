...
// src/services/AwsPollyService.ts
var AwsPollyService = class {
  constructor(awsConfig, voice) {
...
var VoiceSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Voice").setDesc("Select a voice").addDropdown(
...
// src/VoicePlugin.ts
var Voice2 = class extends import_obsidian3.Plugin {
  async speakText() {

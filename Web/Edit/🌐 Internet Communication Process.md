...
2️⃣ **Data Transmission in Packets:**
...
3️⃣ **Transmission Control Protocol (TCP) Layers:**
   - **Application Layer:**
...
7️⃣ **Network Layer and MAC Addressing:**
   - The network layer handles MAC (Media Access Control) addressing.

8️⃣ **IP Address and DNS Caching:**
